  ...
  rows: [
    {
      ...
      rarity: 3,
      location: "Bhigwan",
      notes: "These are a popular attraction for people around Pune during the Winter season. As they've been coming here since many years, an entire business has formed around Bhigwan birdwatching zone. Even the birds have gotten quite used to the birdwatches and allow us to get very close. I remember being so close that my 200-500mm lens couldn't even capture the entire bird in the frame at minimum zoom.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      notes: "I consider this as the worst bird we have in the city. They have very high population, they are constantly breeding and they have 0 positive impact on the environment. Everytime I put some food in my bird feeder or put out some water for the birds, they are the first to raid the stocks. If any other bird is enjoying itself in the water bath, they will come in mobs and scare it away. Worst bird ever..",
    },
    {
      id: 4,
      species: "Egrets",
      rarity: 0,
      location: "Everywhere",
      notes: "Quite common near all big and small water bodies",
    },
    {
      id: 5,
      ...
      rarity: 2,
      location: "Everywhere",
      notes: "I have seen these a few times on ARAI and Mahatma Society hill. I've even noticed some of them at various places around Pune City area. But they are very low in numbers and not as common as the Scaly Breasted Munia. <br> Like all munias, it is very small, maybe the size of an average person's fist, or even smaller. It is red in color with white spots.",
    },
    {
      id: 6,
      ...
      rarity: 2,
      location: "Everywhere",
      notes: "Apart from Bhigwan, I've seen them a couple of times in the ARAI quarry. <br>They are Lemon Yellow in colour with a black/brown back and like most wagtails they can be seen in dancing across the muddy areas around a water body wagging their tail up and down",
    },
    {
      id: 7,
