...
function draw()
{
  ...
  if(phase!=3)
  {
    ...
    noStroke();
    fill(0);
    text("Select a color and click on the 'create environment' button.",900,160);
  ...
  if(phase==2)
  {
    ...
    if(outputFitnesses[index]>95)
    {
      ...
      bestCircles.push(outputs[k]);
      bestCircleFitnesses.push(outputFitnesses[k]);
      console.log("FOUND");
      phase = 3;
      //noLoop();
      //return;
  ...
  if(phase==3)
  {
    ...
    text("% Match : " + bestCircleFitnesses[i],900,260);
    textSize(50);
    text("Generation : " + generations,900,500);
    textSize(20);
    text("Number of elements surveyed : " + numberSurveyed ,900,550);
    text("MATCH FOUND**",900,90);
    textSize(12);
    fill(0);
    text("**Match>95%",900,120);
  }
}
